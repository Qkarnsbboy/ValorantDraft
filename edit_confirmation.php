<?php
	//check to see if something missing
...
<head>
	...
	<meta name="description" content="Edit confirmation for the Valorant Fantasy Team Website. Executes the edit onto the database using SQL and PHP. Either confirms or denies the edit while printing the error.">
...
<body>
  ...
  <!-- Header -->
  <div id="header">
  	<h1 id="valorant-text">Edit Confirmation</h1>
  </div>
	  		...
	  		<div class="col-12 text-center">
	  			...
	  			<?php else: ?>
	  				...
	  				<div class="text-success text-center">
	  					<span class="font-italic"><?php echo $player_name; ?></span> was successfully edited.
	  				</div>
